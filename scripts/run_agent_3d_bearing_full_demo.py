...
def _run_3d_staged_contact_solve(
    ...
    *,
    ...
    actual_area_after_nominal_bootstrap = (
        contact_stage_mode
    ...
    if contact_stage_mode == "load_side_group_boundary_load_single_solve_0p101_actual_area_load":
        stages.append({
            "name": "single_solve_3_roller_boundary_load_0p101n_actual_area_load",
            "contact_scope": "load_side_three_roller_inner_bore_boundary_load_single_solver_sequence_to_0p101n_actual_area_pressure",
            "active_rollers": [12, 1, 2],
            "cage_contact_active": False,
            "inner_radial_displacement": "0[um]",
            "preload_steps": "0.001 0.005 0.01 0.05 0.1 0.1005 0.101",
            ...
            "reuse_existing_solver": False,
            "use_parametric_sweep": True,
            "solver_formulation_diagnostic_role": "single_solve_0p101_actual_inner_bore_selection_area_pressure_only",
            "load_application_fidelity": (
                "inner_bore_boundary_load_load_side_three_roller_single_solve_0p101n_actual_area_pressure_diagnostic_not_design_gate"
            ),
            "physical_acceptance": (
                "actual_area_boundary_load_diagnostic_requires_saved_mph_load_probe_contact_probe_reaction_balance_and_still_not_final"
            ),
        })
    if contact_stage_mode == "load_side_group_boundary_load_single_solve_0p101_actual_area_singlepoint":
        stages.append({
            "name": "single_solve_3_roller_boundary_load_0p101n_actual_area_singlepoint",
            "contact_scope": "load_side_three_roller_inner_bore_boundary_load_singlepoint_0p101n_actual_area_pressure",
            "active_rollers": [12, 1, 2],
            "cage_contact_active": False,
            "inner_radial_displacement": "0[um]",
            "preload_steps": "0.101",
            ...
            "reuse_existing_solver": False,
            "use_parametric_sweep": False,
            "solver_formulation_diagnostic_role": "single_solve_0p101_actual_area_pressure_singlepoint_no_radial_load_parametric_sweep",
            "load_application_fidelity": (
                "inner_bore_boundary_load_load_side_three_roller_singlepoint_0p101n_actual_area_pressure_diagnostic_not_design_gate"
            ),
            "physical_acceptance": (
                "actual_area_singlepoint_boundary_load_diagnostic_requires_saved_mph_load_probe_contact_probe_reaction_balance_and_still_not_final"
            ),
        })
    if contact_stage_mode == "load_side_group_boundary_load_single_solve_0p101_actual_area_fine_bootstrap":
        stages.append({
            "name": "single_solve_3_roller_boundary_load_0p101n_actual_area_fine_bootstrap",
            "contact_scope": "load_side_three_roller_inner_bore_boundary_load_single_solver_sequence_to_0p101n_actual_area_pressure_fine_bootstrap",
            "active_rollers": [12, 1, 2],
            "cage_contact_active": False,
            "inner_radial_displacement": "0[um]",
            "preload_steps": "1e-5 5e-5 1e-4 5e-4 0.001 0.002 0.005 0.01 0.02 0.05 0.08 0.1 0.1005 0.101",
            "sweep_parameter": "radial_load",
            "sweep_unit": "N",
            "radial_load_value": "0.101[N]",
            "mesh_contact_size": "2.4[mm]",
            ...
            "reuse_existing_solver": False,
            "use_parametric_sweep": True,
            "solver_formulation_diagnostic_role": "single_solve_0p101_actual_area_pressure_fine_radial_load_bootstrap_only",
            "load_application_fidelity": (
                "inner_bore_boundary_load_load_side_three_roller_single_solve_0p101n_actual_area_pressure_fine_bootstrap_diagnostic_not_design_gate"
            ),
            "physical_acceptance": (
                "actual_area_fine_bootstrap_boundary_load_diagnostic_requires_saved_mph_load_probe_contact_probe_reaction_balance_and_still_not_final"
            ),
        })
    if contact_stage_mode == "load_side_group_boundary_load_single_solve_0p101_actual_area_fixed_active_bootstrap":
        stages.append({
            "name": "single_solve_3_roller_boundary_load_0p101n_actual_area_fixed_active_bootstrap",
            "contact_scope": "load_side_three_roller_inner_bore_boundary_load_single_solver_sequence_to_0p101n_actual_area_pressure_fixed_active_bootstrap",
            "active_rollers": [12, 1, 2],
            "cage_contact_active": False,
            "inner_radial_displacement": "0[um]",
            "preload_steps": "1e-5 5e-5 1e-4 5e-4 0.001 0.002 0.005 0.01 0.02 0.05 0.08 0.1 0.1005 0.101",
            ...
            "reuse_existing_solver": False,
            "use_parametric_sweep": True,
            "solver_formulation_diagnostic_role": "single_solve_0p101_actual_area_pressure_fixed_active_roller_bootstrap_only",
            "load_application_fidelity": (
                "inner_bore_boundary_load_load_side_three_roller_single_solve_0p101n_actual_area_pressure_fixed_active_bootstrap_diagnostic_not_design_gate"
            ),
            "physical_acceptance": (
                "actual_area_fixed_active_bootstrap_boundary_load_diagnostic_requires_saved_mph_load_probe_contact_probe_reaction_balance_and_still_not_final"
            ),
        })
    if actual_area_after_nominal_bootstrap:
        stages.append({
            "name": "single_solve_3_roller_boundary_load_0p101n_actual_area_after_nominal_bootstrap",
            "contact_scope": "load_side_three_roller_actual_area_pressure_after_nominal_pressure_bootstrap",
            "active_rollers": [12, 1, 2],
            "cage_contact_active": False,
            "inner_radial_displacement": "0[um]",
            "preload_steps": "0.101",
            ...
            "reuse_existing_solver": False,
            "use_parametric_sweep": False,
            "solver_formulation_diagnostic_role": "actual_area_pressure_after_nominal_pressure_bootstrap_only",
            "load_application_fidelity": (
                "inner_bore_boundary_load_load_side_three_roller_actual_area_pressure_after_nominal_bootstrap_diagnostic_not_design_gate"
            ),
            "physical_acceptance": (
                "actual_area_after_nominal_bootstrap_requires_saved_mph_load_probe_contact_probe_reaction_balance_and_still_not_final"
            ),
        })
    ...
    for stage in stages:
        setup = _set_3d_staged_contact_state(
            ...
            inner_bore_load_pressure_expression=stage.get(
                "inner_bore_load_pressure_expression",
